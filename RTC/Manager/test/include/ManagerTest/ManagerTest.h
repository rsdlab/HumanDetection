  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ManagerTest(RTC::Manager* manager);
 ...
 protected:
  ...
  /*!
   */
  RTC::InPort<RTC::TimedString> m_stopIn;
  RTC::TimedString m_start_move;
  /*!
   */
  RTC::InPort<RTC::TimedString> m_start_moveIn;
  ...
  /*!
   */
  RTC::OutPort<RTC::TimedBoolean> m_safetyOut;
  RTC::TimedString m_end_move;
  /*!
   */
  RTC::OutPort<RTC::TimedString> m_end_moveOut;
  RTC::TimedString m_end_manip;
  /*!
   */
  RTC::OutPort<RTC::TimedString> m_end_manipOut;
...
extern "C"
{
  DLL_EXPORT void ManagerTestInit(RTC::Manager* manager);
};

#endif // MANAGER_TEST_H
